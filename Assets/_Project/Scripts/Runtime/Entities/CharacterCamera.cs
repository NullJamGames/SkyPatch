...
namespace NJG.Runtime.Entities
{
    public class CharacterCamera : ValidatedMonoBehaviour
    {
        ...
        private RaycastHit[] _obstructions = new RaycastHit[_maxObstructions];
        ...
        public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
        {
            if (FollowTransform)
            {
                ...
                Quaternion rotationFromInput = Quaternion.Euler(FollowTransform.up * (rotationInput.x * _rotationSpeed));
                ...
                Quaternion targetRotation = Quaternion.Slerp(Transform.rotation, planarRot * verticalRot, 1f - Mathf.Exp(-_rotationSharpness * deltaTime));
                ...
                _obstructionCount = Physics.SphereCastNonAlloc(_currentFollowPosition, _obstructionCheckRadius, 
                    -Transform.forward, _obstructions, TargetDistance, _obstructionLayers, QueryTriggerInteraction.Ignore);
