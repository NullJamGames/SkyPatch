...
#if UNITY_EDITOR
        internal override string Info => "Raycast processing scattered in the environment to detect the color and brightness of light with the input of specific sources." + HDependent;
